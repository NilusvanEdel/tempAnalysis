...
carsac.ctab <- ctab(carsac.sub$motorist,
                    carsac.sub$perspective,
                    carsac.sub$decision,
                    percentages=TRUE, type = "row")
